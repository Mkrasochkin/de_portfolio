...
users_mart = SparkSubmitOperator(
    ...
    application_args=[
        "2022-05-31",
        "30",
        "/user/mkrasochki/data/geo/events/",
        "/user/mkrasochki/geo.csv",
        "/user/mkrasochki/data/analytics/",
    ],
    conf={
...
geo_zone_mart = SparkSubmitOperator(
    ...
    dag=dag_spark,
    application="/lessons/geo_zone_mart.py",
    conn_id="spark_yarn",
    application_args=[
        "2022-05-31",
        "30",
...
recommendations_mart = SparkSubmitOperator(
    ...
    dag=dag_spark,
    application="/lessons/friend_recommendations_mart.py",
    conn_id="spark_yarn",
    application_args=[
        "2022-05-31",
        "30",
...
users_mart >> geo_zone_mart >> recommendations_mart